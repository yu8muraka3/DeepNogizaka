...
# 画像の読み込み
in_dir = "./photo_select_out/yasushi_out/*"
in_jpg=glob.glob(in_dir)
img_file_name_list=os.listdir("./photo_select_out/yasushi_out/")
for i in range(len(in_jpg)):
    ...
    for num, im in enumerate(scratch_face_images):
        ...
        file_name=os.path.join("./face_scratch_image/yasushi",str(fn+"."+str(num)+".jpg"))
